...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true }, (error, { body } = {}) => {
        if (error) {
            ...
            callback(undefined, namepart + ', ' + region + ', ' + country + ': ' + body.current.weather_descriptions[0] + '. It is currently ' + body.current.temperature + ' degrees Celsius. It feels like ' + body.current.feelslike + ' degrees Celsius. The current humidity is ' + body.current.humidity + ' percent.')
